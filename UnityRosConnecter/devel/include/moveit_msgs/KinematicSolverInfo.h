...
struct KinematicSolverInfo_
{
  ...
  _joint_names_type joint_names;
   ...
   typedef std::vector< ::moveit_msgs::JointLimits_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::JointLimits_<ContainerAllocator> >> _limits_type;
  _limits_type limits;
